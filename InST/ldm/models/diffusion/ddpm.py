        ...
        if self.cond_stage_forward is None:
            if hasattr(self.cond_stage_model, "encode") and callable(
                ...
                c = self.cond_stage_model.encode(
                    c, embedding_manager=self.embedding_manager, input_img=x
                )
    ...
    def log_images(
        ...
        **kwargs,
        ...
        if plot_progressive_rows:
            ...
            prog_row = self._get_denoiembedding_parametersse_row_from_list(
    ...
    def on_save_checkpoint(self, checkpoint):
        ...
        if os.path.isdir(self.trainer.checkpoint_callback.dirpath):
            self.embedding_manager.save(
                os.path.join(self.trainer.checkpoint_callback.dirpath, "embeddings.pt")
            )
