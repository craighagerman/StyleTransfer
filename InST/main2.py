...
if __name__ == "__main__":
    ...
    try:
        ...
        # NOTE [CH]: Not really sure what is happening in these two steps.
        #   `data` is an instance of `DataModuleFromConfig`
        #   But ... There doesn't seem to be a config passed in
        data.prepare_data()
        data.setup()
        print("#### Data #####")
        ...
        if not cpu:
            ...
            # ngpu = len(lightning_config.trainer.gpus.split(','))
